...
from apps.accounts_app.views import (
...
from apps.courses_app.views import add_lesson
from django.conf.urls.static import static
from django.conf import settings
from django.views.generic import RedirectView
from django.urls import include

from apps.message_app.views import inquiry_form
...
urlpatterns = [
    ...
    path('courses/', include('apps.courses_app.urls', namespace='courses')),
    ...
    path('quiz/', include('apps.quiz_app.urls', namespace='quiz')),
    ...
    path('dialogues/', include('apps.message_app.urls', namespace='message')),
    path('download/<str:filename>/', download_file, name='download_file'),
    path('sitemap.xml/', sitemap, {'sitemaps': sitemaps}, name='django.contrib.sitemaps.views.sitemap'),
]

handler404 = 'apps.accounts_app.views.custom_404'
