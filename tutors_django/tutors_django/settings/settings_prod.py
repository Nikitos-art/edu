...
#             'filename': '/home/django/backup/django_log.log',
#         },
#     },
#     'loggers': {
#         'django': {
...
# # Set HSTS for one year (recommended for production)
# SECURE_HSTS_SECONDS = 31536000
# SECURE_HSTS_INCLUDE_SUBDOMAINS = True  # Applies HSTS to subdomains
# SECURE_HSTS_PRELOAD = True  # Allows domain to be added to browser HSTS preload lists

# # Ensures all HTTP requests are redirected to HTTPS
# SECURE_SSL_REDIRECT = True

# # Only set this if using a reverse proxy (e.g., Nginx) that forwards HTTPS requests
# SECURE_PROXY_SSL_HEADER = ('HTTP_X_FORWARDED_PROTO', 'https')

# # Specifies trusted origins for CSRF, keeping HTTPS only for production
...
#         'CONFIG': {
#             "hosts": [('127.0.0.1', 6379)],  # Or use your Redis server's actual address
#         },
#     },
# }
